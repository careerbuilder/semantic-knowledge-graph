...
public class FacetFieldAdapterTest {
    ...
    private String[] fieldNames = new String[]
            {
                    ...
                    "onet.v17.id-title",
                    "onet.v17.top.id-title",
                    "skills.v2.did-title",
                    "skills.v2.top.did-title",
                    "skills.v3.did-title",
                    "skills.v3.top.did-title",
                    "joblevel.v1.level-description",
            };
    ...
    public void testAdaptCaroteneV1() throws IOException
    {
        ...
        Assert.assertEquals("carotene.v1.id-title", actual);
    }
    ...
    public void testAdaptCaroteneV1Top()
    {
        ...
        String actual = target.field;
        Assert.assertEquals("carotene.v1.top.id-title", actual);
    }
    ...
    public void testAdaptJobLevel() throws IOException
    {
        ...
        String actual = target.field;
        Assert.assertEquals("joblevel.v1.level-description", actual);
    }
